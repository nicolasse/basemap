...
List directories under `features/`, match semantically, confirm or ask.
...
Report: ✅ Pass / ⚠️ Warning / ❌ Violation
...
- ⚠️ Warnings: suggest, let dev decide
